...
def upgrade():
    ...
    sa.PrimaryKeyConstraint('actor_id', name=op.f('pk_notify_actor'))
    )
    ...
    sa.ForeignKeyConstraint(['actor_id'], ['notify_actor.actor_id'], name=op.f('fk_endorsement_actor_id_notify_actor'), ondelete='NO ACTION'),
    ...
    sa.ForeignKeyConstraint(['actor_id'], ['notify_actor.actor_id'], name=op.f('fk_endorsement_request_actor_id_notify_actor'), ondelete='NO ACTION'),
