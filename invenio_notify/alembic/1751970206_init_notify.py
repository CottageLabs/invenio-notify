...
def upgrade():
    ...
    sa.UniqueConstraint('actor_id', name=op.f('uq_actor_actor_id'))
    )
    ...
    sa.Column('created', sa.DateTime(), nullable=False),
    sa.Column('updated', sa.DateTime(), nullable=False),
    sa.ForeignKeyConstraint(['actor_id'], ['actor.id'], name=op.f('fk_actor_map_actor_id_actor'), ondelete='CASCADE'),
    ...
    sa.ForeignKeyConstraint(['actor_id'], ['actor.id'], name=op.f('fk_endorsement_actor_id_actor'), ondelete='NO ACTION'),
    ...
    sa.ForeignKeyConstraint(['actor_id'], ['actor.id'], name=op.f('fk_endorsement_request_actor_id_actor'), ondelete='NO ACTION'),
