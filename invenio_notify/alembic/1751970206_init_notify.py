...
def upgrade():
    ...
    op.create_table('actor_map',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('user_id', sa.Integer(), nullable=False),
    sa.Column('actor_id', sa.Integer(), nullable=False),
    sa.Column('created', sa.DateTime(), nullable=False),
    sa.Column('updated', sa.DateTime(), nullable=False),
    sa.ForeignKeyConstraint(['actor_id'], ['notify_actor.id'], name=op.f('fk_actor_map_actor_id_notify_actor'), ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['user_id'], ['accounts_user.id'], name=op.f('fk_actor_map_user_id_accounts_user'), ondelete='CASCADE'),
    ...
    sa.ForeignKeyConstraint(['actor_id'], ['notify_actor.id'], name=op.f('fk_endorsement_actor_id_notify_actor'), ondelete='NO ACTION'),
    ...
    sa.ForeignKeyConstraint(['actor_id'], ['notify_actor.id'], name=op.f('fk_endorsement_request_actor_id_notify_actor'), ondelete='NO ACTION'),
