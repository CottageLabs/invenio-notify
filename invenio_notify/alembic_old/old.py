...
def upgrade():
    ...
    op.create_table('notify_actor_map',
                    ...
                    sa.ForeignKeyConstraint(['actor_id'], ['notify_actor.id'],
                                            name=op.f('fk_actor_map_actor_id_notify_actor'), ondelete='CASCADE'),
                    sa.ForeignKeyConstraint(['user_id'], ['accounts_user.id'],
                                            name=op.f('fk_actor_map_user_id_accounts_user'), ondelete='CASCADE'),
                    sa.PrimaryKeyConstraint('id', name=op.f('pk_actor_map'))
                    )
    op.create_index(op.f('ix_actor_map_actor_id'), 'actor_map', ['actor_id'], unique=False)
    op.create_index(op.f('ix_actor_map_user_id'), 'actor_map', ['user_id'], unique=False)
    ...
    op.create_table('endorsement_request',
                    ...
                    sa.ForeignKeyConstraint(['record_id'], ['rdm_records_metadata.id'],
                                            name=op.f('fk_endorsement_request_record_id_rdm_records_metadata'),
                                            ondelete='NO ACTION'),
                    sa.ForeignKeyConstraint(['actor_id'], ['notify_actor.id'],
                                            name=op.f('fk_endorsement_request_actor_id_notify_actor'),
                                            ondelete='NO ACTION'),
                    sa.ForeignKeyConstraint(['user_id'], ['accounts_user.id'],
                                            name=op.f('fk_endorsement_request_user_id_accounts_user'),
                                            ondelete='NO ACTION'),
    ...
    op.create_index(op.f('ix_endorsement_request_actor_id'), 'endorsement_request', ['actor_id'], unique=False)
    ...
    op.create_table('endorsement_reply',
                    ...
                    sa.Column('created', sa.DateTime(), nullable=False),
                    sa.Column('updated', sa.DateTime(), nullable=False),
                    sa.ForeignKeyConstraint(['endorsement_request_id'], ['endorsement_request.id'], name=op.f(
                        'fk_endorsement_reply_endorsement_request_id_endorsement_request'), ondelete='CASCADE'),
                    sa.ForeignKeyConstraint(['inbox_id'], ['notify_inbox.id'],
                                            name=op.f('fk_endorsement_reply_inbox_id_notify_inbox'),
                                            ondelete='SET NULL'),
                    sa.PrimaryKeyConstraint('id', name=op.f('pk_endorsement_reply'))
                    )
    op.create_index(op.f('ix_endorsement_reply_endorsement_request_id'), 'endorsement_reply',
    ...
    op.create_table('endorsement',
                    ...
                    sa.Column('updated', sa.DateTime(), nullable=False),
                    sa.ForeignKeyConstraint(['inbox_id'], ['notify_inbox.id'],
                                            name=op.f('fk_endorsement_inbox_id_notify_inbox'), ondelete='NO ACTION'),
                    sa.ForeignKeyConstraint(['record_id'], ['rdm_records_metadata.id'],
                                            name=op.f('fk_endorsement_record_id_rdm_records_metadata'),
                                            ondelete='CASCADE'),
                    sa.ForeignKeyConstraint(['actor_id'], ['notify_actor.id'],
                                            name=op.f('fk_endorsement_actor_id_notify_actor'), ondelete='NO ACTION'),
    ...
    op.create_index(op.f('ix_endorsement_actor_id'), 'endorsement', ['actor_id'], unique=False)
...
def downgrade():
    ...
    op.drop_index(op.f('ix_endorsement_request_actor_id'), table_name='endorsement_request')
    ...
    op.drop_index(op.f('ix_actor_map_user_id'), table_name='actor_map')
    op.drop_index(op.f('ix_actor_map_actor_id'), table_name='actor_map')
    op.drop_table('actor_map')
