...
@app.route('/dummy-reviewer/dummy-inbox', methods=['GET', 'POST'])
def dummy_inbox():
    ...
    if request.method == 'GET':
        ...
        return jsonify({
            'status': 'success',
            'message': 'Dummy reviewer inbox endpoint',
            'data': {
                'inbox_id': 'dummy-inbox-001',
        ...
        try:
            ...
            return create_fail_response(400, "Error processing notification")
